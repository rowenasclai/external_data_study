...
url="https://365.cantonfair.org.cn/en-US/search?queryType=1&fCategoryId=461147703003324416&categoryId=461147703003324416&searchWord="
...
def run(playwright1: Playwright) -> None:
    ...
    # #If it's still the same, wait a tiny bit longer or retry the click
        ...
        print('Processing Page '+str(l)+' '+current_dateTime.strftime("%Y-%m-%d %H:%M:%S"))
        ...
        print('Finish Processing Page '+str(l)+' '+current_dateTime.strftime("%Y-%m-%d %H:%M:%S"))

...
async def main():
    ...
    schema = {
        ...
        "baseSelector": "div.data even, div.data",    # Repeated elements
        "fields": [
            {
                "name": "Reference",
    ...
    async with AsyncWebCrawler() as crawler:
        result = await crawler.arun(
            url="https://www.hongkongairport.com/en/airport-authority/tender-notices/invitation-to-tender.page", 
            config=config
        )
        ...
        if result.success:
            ...
            pd.DataFrame(data).to_csv('HKAA_BID_20260617.csv')
            #print(data)

...
l1_css_schema = {
    ...
    "baseSelector": "#mainContent tr",  # Selector for your L1 grid/table rows
    "fields": [
        {
            "name": "ref",
...
asyncio.run(run_decoupled_crawl("https://www.wsd.gov.hk/en/tenders-contracts-and-consultancies/consultancies/award-consultancies/index.html"))
